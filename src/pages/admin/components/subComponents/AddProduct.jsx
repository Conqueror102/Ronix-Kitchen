...
function AddProduct() {
  ...
  // Placeholder: Fetch categories from your backend API
  useEffect(() => {
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit(addProduct)} className="space-y-6">
              ...
              <div>
                ...
                <div className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 ${!image && uploadError ? 'border-red-500' : 'border-softOrange'} border-dashed rounded-lg`}>
                ...
                {imagePreview && (
                  <div className="mt-3">
                    <div className="flex items-center space-x-3">
                      <div className="h-16 w-16 rounded overflow-hidden bg-softOrange/40">
                        <img
                          src={imagePreview}
                          alt="Preview"
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`w-full px-4 py-3 bg-black hover:bg-gray-900 text-white font-medium rounded-lg transition duration-300 flex items-center justify-center ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="bg-white/90 rounded-xl shadow-md overflow-hidden">
          ...
          <div className="p-6">
            {imagePreview ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 bg-softOrange/20 rounded-xl border border-softOrange border-dashed">
                ...
                <p className="text-gray-600 text-sm mt-2">Image preview will appear here</p>
              </div>
            )}

            {imagePreview && (
              <div className="mt-6 p-4 bg-softOrange/20 rounded-xl border border-softOrange">
                <h4 className="font-medium text-black mb-2">Product Card Preview</h4>
                <div className="bg-softOrange/40 rounded-lg overflow-hidden shadow-md">
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-vibrantOrange font-bold">
                    ...
                    <div className="mt-4">
                      <button className="w-full px-3 py-2 bg-black hover:bg-gray-900 text-white text-sm font-medium rounded transition duration-300">
                        Add to Cart
                      </button>
                    </div>
                  </div>
            ...
            {/* Upload status */}
            {uploadedFileId && (
              <div className="mt-4 p-3 bg-blue-500/10 text-blue-600 rounded-lg">
