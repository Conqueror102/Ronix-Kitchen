          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h2 className="text-2xl font-bold text-black mb-2">
                Restaurant <span className="bg-clip-text text-transparent bg-vibrantOrange">Management</span>
              </h2>
        ...
        <div className={`space-y-6 ${selectedRestaurant && !isAdding ? 'md:col-span-2' : 'md:col-span-3'}`}>
          <div className="bg-white/90 rounded-xl shadow-md overflow-hidden">
            <div className="px-6 py-4 border-b border-softOrange/40">
              <h3 className="text-lg font-semibold text-black">Restaurant Locations</h3>
            </div>
            <div className="p-6">
              {isAdding ? (
                <div className="bg-softOrange/20 rounded-xl p-6">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-gray-600 mb-2 font-medium">Restaurant Name</label>
                        <input 
                          type="text" 
                          name="name" 
                          value={formData.name} 
                      ...
                      <div>
                        <label className="block text-gray-600 mb-2 font-medium">Manager Name</label>
                        <input 
                          type="text" 
                          name="manager" 
                      ...
                      <div>
                        <label className="block text-gray-600 mb-2 font-medium">Opening Hours</label>
                        <input 
                          type="text" 
                          name="openingHours" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {restaurants.map((restaurant) => (
                    <div 
                      key={restaurant.id} 
                      className="bg-softOrange/20 rounded-xl overflow-hidden border border-softOrange hover:border-vibrantOrange transition-colors"
                    >
                      ...
                      <div className="p-4">
                        <div className="flex justify-between items-start">
                          <h4 className="text-lg font-semibold text-black">{restaurant.name}</h4>
                        ...
                        <div className="flex items-center mt-3">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-vibrantOrange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                          <span className="text-gray-600 text-sm ml-2">{restaurant.openingHours}</span>
                        </div>
                        <div className="flex items-center mt-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-vibrantOrange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
                          <span className="text-gray-600 text-sm ml-2">{restaurant.phone}</span>
                        </div>
                        <div className="flex items-center justify-between mt-4">
                          <div className="flex items-center">
                            ...
                            <span className="text-black text-sm ml-1 font-medium">{restaurant.rating}</span>
                          </div>
                          <div className="flex space-x-2">
                            ...
                            <button 
                              ...
                              className="p-1.5 bg-vibrantOrange/20 text-vibrantOrange rounded-lg hover:bg-vibrantOrange/30 transition-colors"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
