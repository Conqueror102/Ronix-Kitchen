          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-black font-medium">Hours</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-black font-medium">Contact</h3>
            ...
            <button 
              ...
              className="mt-6 w-full px-4 py-2 bg-black hover:bg-black/90 text-white rounded-lg transition duration-300 flex items-center justify-center"
            >
              Get Directions
            ...
            <form className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full bg-lightOrange border border-softPeach rounded-lg px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-vibrantOrange focus:border-transparent"
