                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            ...
                            <div className="relative" ref={profileDropdownRef}>
                                ...
                                >
                                    <div className="h-9 w-9 rounded-full overflow-hidden border-2 border-black hover:border-yellow-500 transition-colors">
                                        {user && user.photoURL ? (
                                            <img 
                                                src={user.photoURL} 
                                                alt="User Avatar" 
                                            ...
                                            <div className="h-full w-full bg-vibrantOrange s flex items-center justify-center text-white">
