      ...
      <div className="relative  z-10   mx-auto">
       ...
       <div className='bg-softOrange px-4 sm:px-6 lg:px-16 py-16'>
         <div className="text-center  mb-16">
          ...
          <h1 className="text-3xl text-black sm:text-4xl md:text-5xl font-extrabold">
            Our <span className="bg-clip-text text-transparent bg-vibrantOrange">Services</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {services.map((service) => (
            <div 
              key={service.id}
              className="bg-white backdrop-blur-sm rounded-xl p-6  shadow-lg hover:shadow-xl transition duration-300"
            >
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-vibrantOrange mb-2">{service.title}</h3>
                  <p className="text-gray-500 mb-4">{service.description}</p>
                  
                  <ul className="space-y-2">
                    {service.features.map((feature, index) => (
                      <li key={index} className="flex items-start gap-2">
                        <svg className="h-5 w-5 text-black mt-0.5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
